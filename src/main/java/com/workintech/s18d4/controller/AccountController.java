...
public class AccountController {
    ...
    // Belirli bir hesap ID'sine göre hesap döner
    @GetMapping("/{id}")
    ...
    public AccountResponse update(@RequestBody Account account, @PathVariable long customerId) {
        ...
        if (toBeUpdateAccount == null){
            throw new RuntimeException("Account("+account.getId()+") not found this customer: " + customerId);
        }
    ...
    // Belirli bir hesap ID'sine göre hesap siler
    @DeleteMapping("/{id}")
